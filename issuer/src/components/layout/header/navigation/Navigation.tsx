          ...
          <Nav className="justify-content-end">
            {appState.isAuthenticated && (
              <>
                ...
                <Nav.Item>
                  <Nav.Link as={'span'}>
                    <span>| Hey, {appState.username}</span>
                  </Nav.Link>
                </Nav.Item>
              </>
            )}
            ...
            {!appState.isAuthenticated && (
              <>
                <Nav.Item>
                  <Nav.Link as={NavLink} activeClassName='is-active' to={routes.APPLICANT_LOGIN}>Register Your Project</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link as={NavLink} activeClassName='is-active' to={routes.ISSUER_LOGIN}>Sign In</Nav.Link>
                </Nav.Item>
                {/* <Nav.Item
