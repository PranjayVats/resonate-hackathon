    ...
    <div className='App'>
        <Navbar>
          <Navbar.Header>
            <Navbar.Brand>
              <Link to='/'>
                <img src="https://logodix.com/logo/1604270.jpg" alt="logo" style={{height: '100px',width: "190px",margin: "-10px", paddingLeft: '20px'}} /> 
              </Link>
            </Navbar.Brand>
            <Navbar.Toggle />
          </Navbar.Header>
          <Navbar.Collapse>
            <Nav pullRight>
              { isAuthenticated
                ? <>
                    <NavItem onClick={handleLogout}><strong>LogOut</strong></NavItem>
                  </>
                : <>
                    <LinkContainer to='/signup'>
                      <NavItem><strong>Sign Up</strong></NavItem>
                    </LinkContainer>
                    <LinkContainer to='/login'>
                      <NavItem><strong>Login</strong></NavItem>
                    </LinkContainer>
                  </>
              }
            </Nav>
